...
{	
  ...
  var previewProperty : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    previewProperty = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (previewProperty, new GUIContent("Preview"));
    if (previewProperty.boolValue)
